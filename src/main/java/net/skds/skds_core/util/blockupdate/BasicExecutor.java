...
import net.skds.skds_core.network.DebugPacket;
import net.skds.skds_core.network.PacketHandler;
...
public abstract class BasicExecutor implements Runnable {
	...
	protected BasicExecutor(ServerWorld w, BiConsumer<UpdateTask, ServerWorld> action) {
		this.w = w;
		this.action = action;
	}
